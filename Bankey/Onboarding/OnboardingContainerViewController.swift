    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate(
            [
                ...
                // Espaço acima da NavigationView
            ]
        )
        ...
        NSLayoutConstraint.activate([
            ...
            backButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -32), // Espaço acima da NavigationView
        ])
    }
...
extension OnboardingContainerViewController {
    ...
    @objc func backTapped(_ sender: UIButton) {
        if let previousVC = getPreviousViewController(from: currentVC) {
            pageViewController
                .setViewControllers([previousVC], direction: .reverse, animated: true) { [weak self] _ in
